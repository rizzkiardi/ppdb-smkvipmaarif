...
@section('content')
    ...
    <div class="px-6">
        ...
        <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
            <p class="text- mb-1">Terakhir, unggah Dokumen.</p>
            ...
            <form action="{{ route('pendaftaran.dokumen.store') }}" method="POST" enctype="multipart/form-data" class="max-w-xl mx-auto ">
                ...
                <div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="file" id="skl" name="skl" class="block w-full mb-1 text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none">
                        @error('skl')
                            <div class="py-1 px-4 mb-4 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">
                                <span class="text-sm italic">{{ $message }}</span>
                            </div>
                    ...
                    <div class="mb-5">
                        <label for="ijazah" class="block mb-1 text-sm font-medium text-gray-900" >Ijazah <span class="text-sm text-red-700">*</span></label>
                        <input type="file" id="ijazah" name="ijazah" class="block w-full mb-1 text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none">
                        @error('ijazah')
                            <div class="py-1 px-4 mb-4 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">
                                <span class="text-sm italic">{{ $message }}</span>
                            </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="file" id="kk" name="kk" class="block w-full mb-1 text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none">
                        @error('kk')
                            <div class="py-1 px-4 mb-4 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">
                                <span class="text-sm italic">{{ $message }}</span>
                            </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="file" id="akte" name="akte" class="block w-full mb-1 text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none">
                        @error('akte')
                            <div class="py-1 px-4 mb-4 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">
                                <span class="text-sm italic">{{ $message }}</span>
                            </div>
